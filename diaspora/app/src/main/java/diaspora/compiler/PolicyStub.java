...
public class PolicyStub extends Stub {
	...
	public TreeSet<MethodStub> getMethods() {
    	...
    	while ((!ancestorClass.getSimpleName().equals("DiasporaServerPolicyLibrary")) &&
    			(!ancestorClass.getSimpleName().equals("DiasporaGroupPolicyLibrary"))) {
	...
	public String getStubClassDeclaration() {
		...
		buffer.append("diaspora.kernel.common.KernelObjectStub"); //$NON-NLS-1$
	...
	public String getStubFields() {
		StringBuilder buffer = new StringBuilder();
		buffer.append(indenter.indent() + "diaspora.kernel.common.KernelOID $__oid = null;" + EOLN);
	...
	public String getStubConstructors() {
		StringBuilder buffer = new StringBuilder();
		buffer.append(indenter.indent() + "public " + stubName + "(diaspora.kernel.common.KernelOID oid) {" + EOLN);
	...
	public String getStubAdditionalMethods() {
		...
		buffer.append(indenter.indent() + "public diaspora.kernel.common.KernelOID $__getKernelOID() {" + EOLN);
		...
		buffer.append(indenter.tIncrease() + "diaspora.kernel.common.KernelRPC rpc = new diaspora.kernel.common.KernelRPC($__oid, method, params);" + EOLN);
		buffer.append(indenter.tIncrease() + "try {" + EOLN);
		buffer.append(indenter.tIncrease(2) + "return diaspora.kernel.common.GlobalKernelReferences.nodeServer.getKernelClient().makeKernelRPC(this, rpc);" + EOLN);
		buffer.append(indenter.tIncrease() + "} catch (diaspora.kernel.common.KernelObjectNotFoundException e) {" + EOLN);
		...
		*/
		...
		/*
		buffer.append(indenter.indent() + "public void $__initialize(diaspora.common.AppObject $param_AppObject_1) { " + EOLN);
		buffer.append(indenter.tIncrease() + "java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();" + EOLN);
		buffer.append(indenter.tIncrease() + "String $__method = \"$__initialize\";" + EOLN);
