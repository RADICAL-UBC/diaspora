...
public final class AppStub extends Stub {
	...
	public String getStubClassDeclaration() {
		...
		buffer.append("diaspora.common.AppObjectStub"); //$NON-NLS-1$
	...
	public String getStubFields() {
		StringBuilder buffer = new StringBuilder();
		buffer.append(indenter.indent() + "diaspora.dms.DiasporaPolicy.DiasporaClientPolicy $__client = null;" + EOLN);
	...
	public String getStubAdditionalMethods() {
		...
		buffer.append(indenter.indent() + "public void $__initialize(diaspora.dms.DiasporaPolicy.DiasporaClientPolicy client) {" + EOLN);
