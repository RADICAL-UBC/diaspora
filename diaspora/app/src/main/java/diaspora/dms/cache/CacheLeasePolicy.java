...
import diaspora.common.DiasporaObjectNotAvailableException;
 ...
 *
 */
public class CacheLeasePolicy extends DiasporaPolicy {
	 ...
	 *
	 */
	public static class CacheLeaseClientPolicy extends DiasporaClientPolicy {
		...
		public Object onRPC(String method, ArrayList<Object> params) throws Exception {
			...
			if (leaseStillValid()) {
				...
				try {
					...
					if (cachelease == null) {
						throw new DiasporaObjectNotAvailableException("Could not get lease.");
					}
					...
					throw new DiasporaObjectNotAvailableException("Could not contact Diaspora server.");
				} catch (KernelObjectNotFoundException e) {
					throw new DiasporaObjectNotAvailableException("Could not find server policy object.");
				}
			}
			return ret;
		}
	 ...
	 *
	 */
	public static class CacheLeaseServerPolicy extends DiasporaServerPolicy {
		static private Logger logger = Logger.getLogger("diaspora.dms.DHTPolicy.CacheLeaseServerPolicy");
		private Integer lease;
		private Date leaseTimeout;
		...
		private CacheLease getNewLease() {
			...
			return new CacheLease(lease, leaseTimeout, diaspora_getAppObject());
		}
	 ...
	 *
	 */
	public static class CacheLeaseGroupPolicy extends DiasporaGroupPolicy {
